...
export const BgImage = ({
  ...
  return (
    <div className="absolute inset-0 z-0 select-none pointer-events-none overflow-hidden">
      {/* Parallax Image using Motion component */}
      <motion.img
        style={{ y }}
        src={imageAddress}
        alt="Earth horizon background"
        /* Reduced height from h-[130%] to h-[115%] since vertical displacement is smaller */
        className="w-full h-[115%] object-cover object-center opacity-100 scale-105"
      />
...
export function HeroSection({ setImageModalOpen, handleResetZoom }: any) {
  // 1. Ref attached to the container section to track scroll position
  const sectionRef = useRef<HTMLElement>(null);

  // 2. Track scroll position relative to this section
  const { scrollYProgress } = useScroll({
    target: sectionRef,
    offset: ["start start", "end start"], // Starts tracking when top hits viewport top, ends when bottom hits viewport top
  });
  ...
  return (
    <section
      ref={sectionRef}
      className="relative pt-32 pb-16 sm:pt-38 sm:pb-24 overflow-hidden border-b border-zinc-800/80 bg-zinc-950"
    >
      {/* Background Image Container with Parallax Transform */}
      <BgImage
        y={y}
        imageAddress={
          // "https://images.unsplash.com/photo-1723374140733-298f96ec315b?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"

          "https://images.unsplash.com/photo-1649047198250-a8c29163c3eb?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center space-y-7">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-medium border border-zinc-800 bg-zinc-900/90 text-zinc-300 shadow-sm hover:border-zinc-700 transition-colors cursor-pointer backdrop-blur-sm">
          ...
          <span className="text-zinc-400">
            Visual DAG Spreadsheet Orchestration Engine
          </span>
        ...
        <p className="max-w-3xl mx-auto text-base sm:text-lg text-zinc-400 leading-relaxed font-normal">
          Eliminate broken VLOOKUP formulas, repetitive copy-pasting, and
          fragile macros. UNIXL delivers deterministic multi-sheet
          reconciliation, automated time-series expansion, and audited data
          governance—backed by dedicated PostgreSQL row-level security.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link href="/auth/sign-in">
            <Button
              size="lg"
              className="h-11 px-7 text-sm font-semibold gap-2 shadow-sm cursor-pointer bg-zinc-900"
            >
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-primary/25 selection:text-primary">
      ...
      <section
        ...
        className="py-20 sm:py-28 border-b border-zinc-800/80 relative"
      >
        {/* <BgImage
          y={y}
          imageAddress={
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
            <Badge
              variant="outline"
              className="text-xs text-zinc-600 border-primary/30 bg-zinc-700/5 font-mono"
            >
            ...
            <p className="text-sm sm:text-base text-zinc-400 leading-relaxed">
              Experience the power of explicit visual pipelines. Watch packets
              stream through ingestion, column alignment, Gemini AI
              reconciliation, and atomic commit without touching raw formulas.
            </p>
              ...
              <div className="lg:col-span-5 space-y-5">
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">
                    Click through the pipeline stages below to observe how data
                    schemas transform and propagate in memory.
                  </p>
                </div>
                ...
                <div className="pt-2 flex items-center gap-3">
                  <Link href="/help">
                    <Button
                      size="sm"
                      variant="outline"
                      className="h-8 text-xs border-zinc-800 hover:bg-zinc-900 gap-1.5 cursor-pointer"
                    >
                  ...
                  <div className="relative p-5 sm:p-7 bg-zinc-950 min-h-[440px] flex items-center justify-center overflow-hidden">
                    ...
                    <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
                      ...
                      <circle
                        ...
                        className="filter drop-shadow-[0_0_4px_rgba(99,102,241,0.9)]"
                      >
                        <animateMotion
                          dur="2.2s"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-5 space-y-4">
                  ...
                  <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
                    Instructors simply log daily session attendance.
                    AnalyticsStackNode detects new date columns, aligns records
                    against master enrollment numbers, and recalculates semester
                    percentages in real time.
                  </p>
                  <ul className="space-y-2 text-xs font-mono text-zinc-300">
                    <li className="flex items-center gap-2">
                      <Check className="size-3 text-primary" /> Eliminates 30+
                      fragmented Excel sheets per course
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="size-3 text-primary" /> Automatic P/A
                      session totals & percentage formulas
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="size-3 text-primary" /> Instant CSV &
                      XLSX export for registrar compliance
                    </li>
                  </ul>
                  <div className="pt-2">
                    <Link href="/help">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-[11px] text-left">
                        ...
                        <tbody className="divide-y divide-zinc-900 text-zinc-300">
                          <tr>
                            <td className="py-1.5 px-2 font-semibold text-zinc-200">
                              2024-CO-001
                            </td>
                            <td className="py-1.5 px-2">Aarav Sharma</td>
                            <td className="py-1.5 px-2 text-center text-primary font-bold">
                              P
                            </td>
                            <td className="py-1.5 px-2 text-center text-primary font-bold">
                              P
                          ...
                          <tr>
                            ...
                            <td className="py-1.5 px-2 text-center text-rose-400 font-bold">
                              A
                            </td>
                            <td className="py-1.5 px-2 text-center text-primary font-bold">
                              P
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 sm:p-8 space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-5 space-y-4">
                  ...
                  <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
                    Raw biometric clocks export thousands of disjointed
                    timestamps. UNIXL normalizes shift spans, applies overtime
                    multiplier tiers, and automatically deducts statutory
                    breaks.
                  </p>
                  <ul className="space-y-2 text-xs font-mono text-zinc-300">
                    <li className="flex items-center gap-2">
                      <Check className="size-3 text-primary" /> Calculates 1.5x
                      and 2.0x overtime tiers deterministically
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="size-3 text-primary" /> Flags clock-in
                      anomalies and missing badge punches
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="size-3 text-primary" /> Direct
                      integration with ADP, Workday, and SAP CSV formats
                    </li>
                  </ul>
                </div>
                      ...
                      <table className="w-full text-[11px] text-left">
                        ...
                        <tbody className="divide-y divide-zinc-900 text-zinc-300">
                          <tr>
                            ...
                            <td className="py-1.5 px-2 text-right font-bold text-primary">
                              6.5 hrs
                            </td>
                            <td className="py-1.5 px-2 text-right font-bold text-white">
                              $1,842.50
                          ...
                          <tr>
                            ...
                            <td className="py-1.5 px-2 text-right font-bold text-zinc-400">
                              0.0 hrs
                            </td>
                            <td className="py-1.5 px-2 text-right font-bold text-white">
                              $1,347.50
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800/80 pb-4">
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mt-0.5">
                    Real-time execution recording: 14 nodes, 3 data sources,
                    zero memory leakage.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <span>
                      {isPlayingVideo ? "Pause Telemetry" : "Resume Telemetry"}
                    </span>
                  </Button>
                </div>
              </div>
                  ...
                  <div className="space-y-2">
                    <div className="bg-zinc-900/90 backdrop-blur-md p-3 rounded-lg border border-zinc-700/70 text-xs font-mono space-y-1 max-w-xl">
                      ...
                      <div className="text-emerald-400 truncate">
                        ✓ [12:54:01] Ingested 91 records from Desk Sheet
                        #CO24009
                      </div>
                      <div className="text-primary truncate">
                        ✓ [12:54:02] AnalyticsStackNode: Generated side-by-side
                        date vector [01-Jul ... 03-Jul]
                      </div>
                      <div className="text-zinc-300 truncate">
                        ✓ [12:54:03] Gemini AI: Reconciled 4 mismatched
                        enrollment keys
                      </div>
                    </div>
                  </div>
      ...
      <section
        id="architecture"
        className="py-20 sm:py-28 border-b border-zinc-800/80 bg-zinc-900/20"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-2xl space-y-2">
              <Badge
                variant="outline"
                className="text-xs text-primary border-primary/30 bg-primary/5 font-mono"
              >
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                A six-node architecture handling daily ingestion, student
                matching, time-series expansion, and MasterSheet updates without
                script maintenance.
              </p>
            </div>
          ...
          >
            ...
            <div className="absolute bottom-4 right-4 bg-zinc-900/90 backdrop-blur-md px-3.5 py-2 rounded-lg border border-zinc-700/70 text-xs text-zinc-300 flex items-center gap-2 shadow-lg group-hover:border-primary/60 transition-all">
              ...
              <span className="font-mono text-[11px]">
                Click to inspect full architecture blueprint
              </span>
            </div>
          </div>
      ...
      <section
        id="features"
        className="py-20 sm:py-28 border-b border-zinc-800/80"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-12">
          <div className="max-w-2xl space-y-2">
            ...
            <p className="text-sm text-zinc-400 leading-relaxed">
              Engineered to give developer reliability to operational
              spreadsheets without brittle formula chains.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-3 hover:border-zinc-700 transition-colors">
              ...
              <h3 className="text-sm font-bold text-white font-mono">
                Visual DAG Graph Engine
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Connect nodes with typed handles. Unlike Excel where formulas
                are hidden inside cells, UNIXL exposes full data lineage and
                execution sequence explicitly.
              </p>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-3 hover:border-zinc-700 transition-colors">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Decoupled interfaces: data engineers build the visual node
                graph, while branch staff or teachers enter daily numbers on a
                simplified tabular form.
              </p>
              <div className="pt-2 text-[10px] font-mono text-zinc-500">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-3 hover:border-zinc-700 transition-colors">
              ...
              <h3 className="text-sm font-bold text-white font-mono">
                Time-Series Analytics Stacks
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Stack daily attendance or periodic ledger columns side-by-side
                automatically. Matches IDs across dates without overwriting past
                entries.
              </p>
              <div className="pt-2 text-[10px] font-mono text-zinc-500">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-3 hover:border-zinc-700 transition-colors">
              ...
              <h3 className="text-sm font-bold text-white font-mono">
                AI Schema & Column Alignment
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                One department submits `Roll_No`, another submits `Enrollment`.
                Integrated Gemini and LangChain agents intelligently resolve
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-3 hover:border-zinc-700 transition-colors">
              ...
              <h3 className="text-sm font-bold text-white font-mono">
                Workspace Files & Syncfusion
              </h3>
              <p className="text-xs text-zinc-400 leading-relaxed">
                Hierarchical folder directory directly inside your project.
                Inspect large datasets in high-performance Syncfusion sheets and
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-3 hover:border-zinc-700 transition-colors">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                All workflows, datasets, and history remain within your
                designated Supabase PostgreSQL instance. Zero model training on
                customer data.
              </p>
              <div className="pt-2 text-[10px] font-mono text-zinc-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 overflow-hidden hover:border-zinc-700 transition-all flex flex-col justify-between">
              <div className="relative h-44 w-full bg-zinc-950 overflow-hidden">
                ...
                <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between font-mono text-xs">
                  ...
                  <span className="text-zinc-300 bg-zinc-950/80 px-2 py-0.5 rounded">
                    Attendance & Credits
                  </span>
                </div>
              </div>
              <div className="p-6 space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Teachers input daily roll-call attendance from desk view. The
                  graph matches Enrollment IDs, stacks daily P/A records
                  chronologically, and updates semester credit totals in the
                  institution MasterSheet.
                </p>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 overflow-hidden hover:border-zinc-700 transition-all flex flex-col justify-between">
              ...
              <div className="p-6 space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Reconcile daily SKU counts across multiple fulfillment hubs.
                  The graph detects negative variances, flags missing stock
                  batches, and updates real-time store availability without
                  manual VLOOKUP joins.
                </p>
                <div className="pt-2 border-t border-zinc-800/80 flex items-center justify-between text-xs font-mono text-zinc-400">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 overflow-hidden hover:border-zinc-700 transition-all flex flex-col justify-between">
              ...
              <div className="p-6 space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Biometric punch clocks export raw timestamps daily. The node
                  pipeline aggregates total hours, calculates overtime
                  multiplier tiers, reconciles employee tax bands, and outputs
                  payroll-ready CSVs.
                </p>
                <div className="pt-2 border-t border-zinc-800/80 flex items-center justify-between text-xs font-mono text-zinc-400">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 overflow-hidden hover:border-zinc-700 transition-all flex flex-col justify-between">
              ...
              <div className="p-6 space-y-3">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Track nurse and physician shift rosters against mandatory rest
                  interval regulations. Instantly flags understaffed emergency
                  wards and generates compliance audit trails.
                </p>
                <div className="pt-2 border-t border-zinc-800/80 flex items-center justify-between text-xs font-mono text-zinc-400">
      ...
      <section className="py-20 sm:py-28 border-b border-zinc-800/80 bg-zinc-900/20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <p className="text-sm text-zinc-400">
              A side-by-side look at the architectural upgrade from traditional
              sheets.
            </p>
          </div>
              ...
              <div className="p-6 sm:p-8 space-y-3.5 bg-zinc-900/30">
                ...
                <ul className="space-y-2.5 text-zinc-400">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Formulas break silently when columns are added, renamed,
                      or shifted.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-zinc-600 font-mono">✕</span>
                    <span>
                      Operators have full access to overwrite formulas and
                      delete master rows by accident.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-zinc-600 font-mono">✕</span>
                    <span>
                      Reconciling daily dates requires manual VLOOKUP gymnastics
                      and copy-pasting.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-zinc-600 font-mono">✕</span>
                    <span>
                      No visual lineage: nobody knows who built cell `E42` or
                      why it computes `SUM(C2:D10)`.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-6 sm:p-8 space-y-3.5 bg-zinc-900/60">
                ...
                <ul className="space-y-2.5 text-zinc-200">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Visual DAG node cables guarantee clear data provenance and
                      unbreakable dependencies.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary font-mono font-bold">✓</span>
                    <span>
                      Desk Panel decouples inputs: non-technical staff only see
                      their clean input form.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary font-mono font-bold">✓</span>
                    <span>
                      Analytics Stack nodes expand daily dates automatically
                      side-by-side without manual merge.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary font-mono font-bold">✓</span>
                    <span>
                      Atomic workspace file backups with built-in rollback
                      protection and diff preview.
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800 pb-6">
              <div className="space-y-1">
                ...
                <h3 className="text-2xl font-bold text-white">
                  Bank-Grade Security for Operational Data
                </h3>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-zinc-400">
              <div className="space-y-2">
                <div className="font-bold text-zinc-200 font-mono flex items-center gap-2">
                  <Database className="size-4 text-primary" /> Dedicated
                  PostgreSQL RLS
                </div>
                <p className="leading-relaxed">
                  Every project runs isolated schemas in Supabase PostgreSQL
                  with strict row-level security and automated hourly snapshots.
                </p>
              </div>
              <div className="space-y-2">
                <div className="font-bold text-zinc-200 font-mono flex items-center gap-2">
                ...
                <p className="leading-relaxed">
                  All sheet payloads and API communications are encrypted using
                  TLS 1.3 in transit and AES-256 at rest.
                </p>
              </div>
              <div className="space-y-2">
                <div className="font-bold text-zinc-200 font-mono flex items-center gap-2">
                  <Server className="size-4 text-primary" /> Air-Gapped /
                  Self-Host Ready
                </div>
                <p className="leading-relaxed">
                  Deploy UNIXL inside your own AWS VPC, Azure tenant, or
                  on-premises Docker cluster for total sovereignty.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-8 sm:p-14 text-center space-y-6 shadow-xl relative overflow-hidden">
            <div className="space-y-2 max-w-xl mx-auto">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                Join operational leaders building reproducible, visual data
                pipelines with UNIXL today.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <Link href="/auth/sign-in">
                <Button
                  size="lg"
                  className="h-11 px-7 text-sm font-semibold gap-2 shadow-xs cursor-pointer"
                >
              ...
              <Link href="/help">
                <Button
                  variant="outline"
                  size="lg"
                  className="h-11 px-6 text-sm font-medium border-zinc-800 bg-zinc-900 hover:bg-zinc-800 cursor-pointer"
                >
            ...
            <p className="text-[11px] font-mono text-zinc-500">
              Open-source friendly · Managed cloud or self-host · Instant
              onboarding
            </p>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-xl flex flex-col animate-in fade-in duration-200">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-zinc-400">
                  Attendance Pipeline · Side-by-Side Dates Expansion ·
                  MasterSheet Commit
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/help" onClick={() => setImageModalOpen(false)}>
                <Button
                  size="sm"
                  variant="outline"
                  className="h-8 text-xs border-zinc-700 bg-zinc-800 hover:bg-zinc-700 gap-1.5"
                >
          ...
          <div className="px-4 sm:px-6 py-2.5 border-t border-zinc-800 bg-zinc-950/80 flex items-center justify-between text-[11px] font-mono text-zinc-400">
            ...
            <span className="hidden sm:inline">
              Diagram Resolution: 4K Native Vector Flow
            </span>
          </div>
        </div>
      )}
